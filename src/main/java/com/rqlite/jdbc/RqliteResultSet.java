...
public class RqliteResultSet implements ResultSet {
  ...
  public boolean getBoolean(int columnIndex) throws SQLException {
    ...
    try {
      bool = Integer.parseInt(boolString);
  ...
  private boolean byteArrayToBoolean(byte[] value) {
    if (value == null) {
      return false;
    }
  ...
  public byte getByte(int columnIndex) throws SQLException {
    ...
    try {
      bValue = Byte.parseByte(byteString);
    } catch (NumberFormatException nfe) {
  ...
  public short getShort(int columnIndex) throws SQLException {
    ...
    short sValue;
    try {
      sValue = Short.parseShort(shortString);
    } catch (NumberFormatException nfe) {
      throw new SQLException(nfe);
    }
  ...
  public int getInt(int columnIndex) throws SQLException {
    ...
    int iValue;
    try {
      iValue = Integer.parseInt(intString);
    } catch (NumberFormatException nfe) {
      throw new SQLException(nfe);
    }
  ...
  public long getLong(int columnIndex) throws SQLException {
    ...
    try {
      lValue = Long.parseLong(longString);
    } catch (NumberFormatException nfe) {
      throw new SQLException(nfe);
    }
  ...
  public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException {
    ...
    BigDecimal bdValue;
    if (value instanceof BigDecimal) {
      bdValue = ((BigDecimal) value).setScale(scale, RoundingMode.HALF_UP);
      return bdValue;
    }
    ...
    try {
      bdValue = new BigDecimal(bigDecimalString);
      bdValue = bdValue.setScale(scale, RoundingMode.HALF_UP);
    } catch (Exception ex) {
  ...
  public InputStream getAsciiStream(int columnIndex) throws SQLException {
    throw new SQLFeatureNotSupportedException(SQL_FEATURE_NOT_SUPPORTED);
  }
  ...
  public int findColumn(String columnLabel) throws SQLException {
    ...
    for (int i = 0; i < result.columns.length; i++) {
      ...
      if (Objects.equals(columnLabel, column)) {
        return i + 1;
      }
    }
  ...
  public void setFetchSize(int rows) throws SQLException {
    checkOpen();
    if (rows < 0) {
      throw new SQLException("Illegal value for fetch size " + rows);
    }
    this.fetchSize = rows;
  }
  ...
  public RowId getRowId(int columnIndex) throws SQLException {
    checkOpen();
    throw new SQLFeatureNotSupportedException(SQL_FEATURE_NOT_SUPPORTED); // TODO: We could get this if we wanted to
  }
  ...
  private void checkOpen() throws SQLException {
    if (this.closed) {
      throw new SQLException("Attempted operation on closed result set");
    }
  }
